...
constexpr uint8_t ASCII_TO_RAW[95] = {
    ...
    0b10000001,   // '0', ord 0x30 (інверсія 0b01111110)
    0b11001111,   // '1', ord 0x31 (інверсія 0b00010001)
    0b10010010,   // '2', ord 0x32 (інверсія 0b01101101)
    0b10000110,   // '3', ord 0x33 (інверсія 0b01111001)
    0b11001100,   // '4', ord 0x34 (інверсія 0b00110011)
    0b10100100,   // '5', ord 0x35 (інверсія 0b01011011)
    0b10100000,   // '6', ord 0x36 (інверсія 0b01011111)
    0b10001111,   // '7', ord 0x37 (інверсія 0b01110000)
    0b10000000,   // '8', ord 0x38 (інверсія 0b01111111)
    0b10000100,   // '9', ord 0x39 (інверсія 0b01111011)
    0b01001000,   // ':', ord 0x3A
    0b01011000,   // ';', ord 0x3B
    0b01000011,   // '<', ord 0x3C
    0b00001001,   // '=', ord 0x3D
...
void IRAM_ATTR HOT LcdDigitsData::timer_interrupt() {
  ...
  const uint32_t min_dt_us = 1000000;   //const uint32_t min_dt_us = 1000
