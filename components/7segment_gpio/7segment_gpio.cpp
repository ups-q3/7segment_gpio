...
constexpr uint8_t ASCII_TO_RAW[95] = {
    ...
    0b00000000,   // '0', ord 0x30
    0b00010001,   // '1', ord 0x31
    0b00100010,   // '2', ord 0x32
    0b00110011,   // '3', ord 0x33
    0b01000100,   // '4', ord 0x34
    0b01010101,   // '5', ord 0x35
    0b01100110,   // '6', ord 0x36
    0b01110111,   // '7', ord 0x37
    0b10001000,   // '8', ord 0x38
    0b10011001,   // '9', ord 0x39
    0b01001000,   // ':', ord 0x3A
    0b01011000,   // ';', ord 0x3B
    0b01000011,   // '<', ord 0x3C
    0b00001001,   // '=', ord 0x3D
